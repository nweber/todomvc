...
},{"./custom-elements":4,"./transposition":8,"./virtual-hyperscript":9,"@cycle/core":1,"matches-selector":65,"vdom-parser":66,"virtual-dom/diff":81,"virtual-dom/patch":88}],7:[function(require,module,exports){
"use strict";
...
},{"./custom-element-widget":3,"./custom-elements":4,"./transposition":8,"@cycle/core":1,"vdom-to-html":70}],8:[function(require,module,exports){
"use strict";
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":96,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":97,"virtual-dom/virtual-hyperscript/parse-tag.js":99,"virtual-dom/vnode/is-thunk":103,"virtual-dom/vnode/is-vhook":104,"virtual-dom/vnode/is-vnode":105,"virtual-dom/vnode/is-vtext":106,"virtual-dom/vnode/is-widget":107,"virtual-dom/vnode/vnode.js":109,"virtual-dom/vnode/vtext.js":111,"x-is-array":114}],10:[function(require,module,exports){
'use strict';
...
},{"./namespace-map":67,"./property-map":68,"virtual-dom/vnode/vnode":109,"virtual-dom/vnode/vtext":111}],67:[function(require,module,exports){
...
},{"./create-attribute":69,"./void-elements":80,"escape-html":71,"param-case":77,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":95,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":97,"virtual-dom/vnode/is-thunk":103,"virtual-dom/vnode/is-vnode":105,"virtual-dom/vnode/is-vtext":106,"virtual-dom/vnode/is-widget":107,"xtend":78}],71:[function(require,module,exports){
/*!
 * escape-html
...
},{"../vnode/is-vhook.js":104,"is-object":87}],90:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":102,"../vnode/is-vnode.js":105,"../vnode/is-vtext.js":106,"../vnode/is-widget.js":107,"./apply-properties":89,"global/document":86}],91:[function(require,module,exports){
...
},{"./create-element":90,"./dom-index":91,"./patch-op":92,"global/document":86,"x-is-array":114}],94:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/is-thunk":103,"../vnode/is-vhook":104,"../vnode/is-vnode":105,"../vnode/is-vtext":106,"../vnode/is-widget":107,"../vnode/vnode.js":109,"../vnode/vtext.js":111,"./hooks/ev-hook.js":96,"./hooks/soft-set-hook.js":97,"./parse-tag.js":99,"x-is-array":114}],99:[function(require,module,exports){
'use strict';
...
},{"./hooks/attribute-hook":95,"./index.js":98,"./svg-attribute-namespace":100,"x-is-array":114}],102:[function(require,module,exports){
...
},{"../vnode/is-vhook":104,"is-object":87}],113:[function(require,module,exports){
var isArray = require("x-is-array")
...
},{"lodash._basecallback":118,"lodash._basefor":124,"lodash.keys":125}],118:[function(require,module,exports){
/**
...
},{"lodash._baseisequal":119,"lodash._bindcallback":121,"lodash.isarray":122,"lodash.pairs":123}],119:[function(require,module,exports){
/**
...
},{"lodash.isarray":122,"lodash.istypedarray":120,"lodash.keys":125}],120:[function(require,module,exports){
/**
...
},{"lodash.keys":125}],124:[function(require,module,exports){
/**
 * lodash 3.0.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":126,"lodash.isarguments":127,"lodash.isarray":128}],126:[function(require,module,exports){
/**
...
var _componentsTodosIndex = require('./components/todos/index');

var _componentsTodosIndex2 = _interopRequireDefault(_componentsTodosIndex);
...
(0, _cycleCore.run)(main, {
  ...
  initialHash: function initialHash() {
    return _cycleCore.Rx.Observable.just(window.location.hash);
  },
  hashchange: function hashchange() {
    return _cycleCore.Rx.Observable.fromEvent(window, 'hashchange');
  }
});

},{"./components/todos/index":131,"./drivers":137,"@cycle/core":1,"@cycle/dom":5}],130:[function(require,module,exports){
'use strict';
...
function intent(DOM) {
  ...
  return {
    delete$: DOM.select(name + ' .destroy').events('click').map(function () {
      return { name: name };
    }),
    toggle$: DOM.select(name + ' .toggle').events('change').map(function () {
      return { name: name };
    }),
    startEdit$: DOM.select(name + ' label').events('dblclick').map(function () {
      return { name: name };
    }),
    cancelEdit$: DOM.select(name + ' .edit').events('keyup').filter(function (ev) {
      return ev.keyCode === _utils.ESC_KEY;
    }).map(function () {
      return { name: name };
    }),
    stopEdit$: DOM.select(name + ' .edit').events('keyup').filter(function (ev) {
      return ev.keyCode === _utils.ENTER_KEY;
    }).merge(DOM.select(name + ' .edit').events('blur')).map(function (ev) {
      return { title: ev.currentTarget.value, name: name };
    }).share()
  };
}
...
function model(props$, actions) {
  ...
  var editing$ = _cycleCore.Rx.Observable.merge(actions.startEdit$.map(function () {
    return true;
  }), actions.stopEdit$.map(function () {
    return false;
  }), actions.cancelEdit$.map(function () {
    return false;
  })).startWith(false);
  return _cycleCore.Rx.Observable.combineLatest(sanitizedProps$, editing$, function (_ref, editing) {
    var title = _ref.title;
    var completed = _ref.completed;
    return { title: title, completed: completed, editing: editing };
  });
}
...
function view(state$) {
  ...
  return state$.map(function (_ref2) {
    ...
    return (0, _cycleDom.h)('li.todoRoot' + name + completedClass + editingClass, [(0, _cycleDom.h)('div.view', [(0, _cycleDom.h)('input.toggle', {
      type: 'checkbox',
      checked: (0, _utils.propHook)(function (elem) {
        return elem.checked = completed;
      })
    }), (0, _cycleDom.h)('label', title), (0, _cycleDom.h)('button.destroy')]), (0, _cycleDom.h)('input.edit', {
      type: 'text',
...
function todoItem(_ref3) {
  ...
  var actions = intent(DOM, name);
  var state$ = model(props$, actions);
  var vtree$ = view(state$, name);
  return {
    DOM: vtree$,
...
},{"../utils":138,"@cycle/core":1,"@cycle/dom":5}],131:[function(require,module,exports){
'use strict';
...
var _localStorageSource = require('./local-storage-source');

var _localStorageSource2 = _interopRequireDefault(_localStorageSource);

var _localStorageSink = require('./local-storage-sink');

var _localStorageSink2 = _interopRequireDefault(_localStorageSink);
  ...
  return function (todosData) {
    return {
      list: todosData.list.map(function (data) {
        var props$ = _cycleCore.Rx.Observable.just(data);
        return {
          id: data.id,
          title: data.title,
          completed: data.completed,
          todoItem: (0, _todoItem2['default'])({ DOM: DOM, props$: props$ }, '.item' + data.id)
        };
      }),
...
function makeItemActions(typeItemActions, amendedState$) {
  return (0, _lodashMapvalues2['default'])(typeItemActions, function (irrelevant, actionKey) {
    return amendedState$.filter(function (todosData) {
      ...
      return _cycleCore.Rx.Observable.merge(todosData.list.map(function (i) {
...
function todos(_ref) {
  var DOM = _ref.DOM;
  var hashchange = _ref.hashchange;
  var initialHash = _ref.initialHash;
  ...
  var proxyItemActions = (0, _lodashMapvalues2['default'])(typeItemActions, function () {
    return new _cycleCore.Rx.Subject();
  });
...
},{"../todo-item":130,"./intent":132,"./local-storage-sink":133,"./local-storage-source":134,"./model":135,"./view":136,"@cycle/core":1,"lodash.mapvalues":117}],132:[function(require,module,exports){
'use strict';
...
function intent(DOM, hashchange, initialHash, itemActions) {
  var getTodoItemId = function getTodoItemId(name) {
    return parseInt(name.replace('.item', ''));
  };

  return {
    changeRoute$: _cycleCore.Rx.Observable.concat(initialHash.map(function (hash) {
      return hash.replace('#', '');
    }), hashchange.map(function (ev) {
      return ev.newURL.match(/\#[^\#]*$/)[0].replace('#', '');
    })),

    clearInput$: DOM.select('.new-todo').events('keydown').filter(function (ev) {
      return ev.keyCode === _utils.ESC_KEY;
    }),

    insertTodo$: DOM.select('.new-todo').events('keydown').filter(function (ev) {
    ...
    toggleTodo$: itemActions.toggle$.map(function (_ref) {
      var name = _ref.name;
      return name;
    }).map(getTodoItemId),

    deleteTodo$: itemActions.delete$.map(function (_ref2) {
      var name = _ref2.name;
      return name;
    }).map(getTodoItemId),

    editTodo$: itemActions.edit$.map(function (_ref3) {
      var name = _ref3.name;
...
},{"../../utils":138,"@cycle/core":1}],133:[function(require,module,exports){
"use strict";
...
function makeModification$(actions) {
  var clearInputMod$ = actions.clearInput$.map(function () {
    return function (todosData) {
      return todosData;
    };
  });

  var insertTodoMod$ = actions.insertTodo$.map(function (todoTitle) {
    return function (todosData) {
  ...
  var editTodoMod$ = actions.editTodo$.map(function (action) {
    return function (todosData) {
  ...
  var toggleAllMod$ = actions.toggleAll$.map(function () {
    return function (todosData) {
  ...
  var deleteCompletedsMod$ = actions.deleteCompleteds$.map(function () {
    return function (todosData) {
...
function model(actions, sourceTodosData$) {
  var modification$ = makeModification$(actions);
  var route$ = _cycleCore.Rx.Observable.just('/').merge(actions.changeRoute$);

  return modification$.merge(sourceTodosData$).scan(function (todosData, modFn) {
...
function view(todos$) {
  return todos$.map(function (todos) {
    return (0, _cycleDom.h)('div', [renderHeader(), renderMainSection(todos), renderFooter(todos)]);
  });
}
...
},{"@cycle/core":1,"@cycle/dom":5}],137:[function(require,module,exports){
'use strict';
...
exports['default'] = { makeLocalStorageSinkDriver: makeLocalStorageSinkDriver, makeLocalStorageSourceDriver: makeLocalStorageSourceDriver };
module.exports = exports['default'];
