...
import intent from 'react-cycle-shared/components/todos/intent';
import model from 'react-cycle-shared/components/todos/model';
import view from './view';
import deserialize from 'react-cycle-shared/components/todos/local-storage-source';
import serialize from 'react-cycle-shared/components/todos/local-storage-sink';
